/* =========================================================
   ...
   - Prevent guest users from using private account features
...
(() => {
    ...
    function normalizeUser(user) {
         ...
         * The current authentication session must also have
         * been established with Google.
         */
    ...
    function bindAuthStateListener() {
         ...
         * Duplicate state events are removed by signature
         * comparison in updateCurrentUser().
         */
    ...
    async function requestGoogleLogin(
        ...
        try {
            ...
            /*
             * signInWithRedirect normally does not return a
             * user because the page is navigating away.
             */
    ...
    async function requireReferralAccess(
        options = {}
    ) {
        return requireGoogle({
            ...options,
    ...
    async function requireRewardAccess(
        options = {}
    ) {
        return requireGoogle({
            ...options,
    ...
    async function requireWithdrawalAccess(
        options = {}
    ) {
        return requireGoogle({
            ...options,
