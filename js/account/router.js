    ...
    const PAGE_DEFINITIONS =
        Object.freeze({
            ...
            "referral-statistics": {
                ...
                getView() {
                    return window.ReferralStatisticsView;
                },

                getModule() {
                    return window.ReferralStatisticsModule;
                }
            },
            ...
            "reward-center": {
                ...
                getView() {
                    return window.RewardView;
                },

                getModule() {
                    return window.RewardModule;
                }
            },
            ...
            "withdraw-history": {
                ...
                getView() {
                    return window.WithdrawHistoryView;
                },

                getModule() {
                    return window.WithdrawHistoryModule;
                }
            },
            ...
            "referral-rules": {
                ...
                getView() {
                    return window.ReferralRulesView;
                },

                getModule() {
                    return window.ReferralRulesModule;
                }
            }
        });
