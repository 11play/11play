...
/* =========================================================
   ...
   - Explicitly destroy account-page runtime when leaving
     Profile / Offer / Live Chat pages
   ...
   - LiveChatModule cleanup is triggered explicitly when
     leaving account pages, with its page-removal observer
     remaining as an additional safety mechanism
========================================================= */
...
const Router = (() => {
    ...
    /* =====================================================
       ACCOUNT RUNTIME CLEANUP
    ===================================================== */

    function destroyAccountRuntime() {
        if (
        ...
        try {
            ...
            console.warn(
                "[Router] Account runtime cleanup failed.",
                error
            );
    ...
    function render(page) {
        ...
        /*
         * When leaving Profile / Offer / Live Chat for a
         * standard application page, destroy the complete
         * account-page runtime before removing its DOM.
         *
         * For Live Chat this immediately hides the tawk.to
         * widget instead of depending only on the asynchronous
         * page-removal MutationObserver.
         *
         * Account-to-account navigation is intentionally left
         * to ProfileRouter.open(), which already destroys the
         * previously active account module before rendering the
         * next account page.
         */
        ...
        if (
            ...
            destroyAccountRuntime();
        }

        /*
         * Remove the previous page DOM only after its runtime
         * has received an explicit cleanup opportunity.
         */
    ...
    function destroy() {
        ...
        /*
         * Explicitly destroy any active account runtime.
         * This also ensures a loaded tawk.to widget is hidden
         * if Router itself is destroyed while Live Chat is
         * currently active.
         */
